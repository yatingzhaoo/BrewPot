        ...
        <div className="relative overflow-visible">
          ...
          >
            {SHOWCASE_IMAGES.map(({ src, alt }, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-[360px] h-[281.5px] rounded-[10px] overflow-hidden shadow-[0_4px_20px_-10px_rgba(0,0,0,0.1)] bg-white border border-gray-100 cursor-pointer snap-center group"

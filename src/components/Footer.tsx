...
export default function Footer() {
  return (
    <footer id="contact" data-analytics-section="footer" className="site-footer">
      <div className="site-footer-inner">
        <div className="site-footer-socials" aria-label="Social links">
          <a
            href="https://x.com/yatingzhao_ux"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="BrewPot on X"
          ...
          <a
            href="https://www.linkedin.com/company/brewpot"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="BrewPot on LinkedIn"
            onClick={() => track('outbound_link_clicked', {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/company/brewpot',
              source: 'footer',
        ...
        <p>© 2026 BrewPot LLC | All rights reserved.</p>
      </div>
    </footer>
  );
}
